interface InitTheme {
  ...
  font_size: string;
  font_family: string;
  font_josefinSans_400: string;
  font_josefinSans_700: string;
}
...
const BasicTheme: InitTheme = {
  ...
  font_josefinSans_400: "JosefinSans_400Regular",
  font_josefinSans_700: "JosefinSans_700Bold",
};

const LightTheme: CustomTheme = {
  ...BasicTheme,
  layout_color: "rgb(239, 239, 239)",
  backgroundColor: "rgb(238, 235, 234)",
